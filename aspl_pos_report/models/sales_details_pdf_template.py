...
class sales_details_pdf_template(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('aspl_pos_report.sales_details_pdf_template')
        docargs = {
        ...
        return report_obj.render('aspl_pos_report.sales_details_pdf_template', docargs)
